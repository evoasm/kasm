...
object CpuidEaxEbxEcxEdx : NullaryInstruction() {
  ...
  override fun trace(tracer: InstructionTracer)  {
    ...
    tracer.traceImplicitWrite(kasm.x64.GpRegister32.EBX, BitRange.BITS_0_63, true)
    tracer.traceImplicitWrite(kasm.x64.GpRegister32.ECX, BitRange.BITS_0_63, true)
