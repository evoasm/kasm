...
object VsubssXmmXmmXmmm32 : XmmXmmXmmm32Instruction(), VectorInstruction, AvxInstruction {
...
object TestRm16Imm16 : R16m16Imm16Instruction() {
...
object TestRm32Imm32 : R32m32Imm32Instruction() {
...
object TestRm64Imm32 : R64m64Imm32Instruction() {
...
object TestRm8R8 : R8m8R8Instruction() {
...
object TestRm16R16 : R16m16R16Instruction() {
...
object TestRm32R32 : R32m32R32Instruction() {
...
object TestRm64R64 : R64m64R64Instruction() {
...
object TzcntR16Rm16 : R16R16m16Instruction(), Bmi1Instruction {
  override fun encode(buffer: ByteBuffer, register1: GpRegister16, register2: GpRegister16, options: EncodingOptions, tracer: InstructionTracer?)  {
    if(tracer != null) trace(tracer, register1, register2)
...
object TzcntR32Rm32 : R32R32m32Instruction(), Bmi1Instruction {
  override fun encode(buffer: ByteBuffer, register1: GpRegister32, register2: GpRegister32, options: EncodingOptions, tracer: InstructionTracer?)  {
    if(tracer != null) trace(tracer, register1, register2)
