...
object EnterwImm16Imm8SpBp : Imm16Imm8Instruction() {
  ...
  override fun trace(tracer: InstructionTracer, immediate1: Short, immediate2: Byte)  {
    ...
    tracer.traceRead(immediate1.toLong(), false, BitSize._16)
    tracer.traceRead(immediate2.toLong(), false, BitSize._8)
    tracer.traceRead(kasm.x64.GpRegister16.SP, true, BitRange._0_15)
    tracer.traceRead(kasm.x64.GpRegister16.BP, true, BitRange._0_15)
    tracer.traceWrite(kasm.x64.GpRegister16.SP, true, BitRange._0_15, true)
    tracer.traceWrite(kasm.x64.GpRegister16.BP, true, BitRange._0_15, true)
    tracer.endTracing()
  }
  override fun encode(buffer: ByteBuffer, parameters: InstructionParameters, options: EncodingOptions, tracer: InstructionTracer?)  {
    encode(buffer, parameters.getShortImmediate(0), parameters.getByteImmediate(1), options, tracer)
