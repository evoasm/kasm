...
object CmpxchgRm8R8Al : R8m8R8Instruction() {
  ...
  override fun trace(tracer: InstructionTracer, register1: GpRegister8, register2: GpRegister8)  {
    ...
    tracer.traceWrite(register1, 0, BitRange.BITS_0_7, false)
    tracer.traceImplicitWrite(kasm.x64.GpRegister8.AL, BitRange.BITS_0_7, false)
    tracer.traceWrite(kasm.x64.RflagsField.OF, false)
    tracer.traceWrite(kasm.x64.RflagsField.SF, false)
    tracer.traceWrite(kasm.x64.RflagsField.ZF, false)
    tracer.traceWrite(kasm.x64.RflagsField.PF, false)
...
object CmpxchgRm16R16Ax : R16m16R16Instruction() {
  ...
  override fun trace(tracer: InstructionTracer, register1: GpRegister16, register2: GpRegister16)  {
    ...
    tracer.traceImplicitWrite(kasm.x64.GpRegister16.AX, BitRange.BITS_0_15, false)
    tracer.traceWrite(kasm.x64.RflagsField.OF, false)
    tracer.traceWrite(kasm.x64.RflagsField.SF, false)
    tracer.traceWrite(kasm.x64.RflagsField.ZF, false)
    tracer.traceWrite(kasm.x64.RflagsField.PF, false)
...
object CmpxchgRm32R32Eax : R32m32R32Instruction() {
  ...
  override fun trace(tracer: InstructionTracer, register1: GpRegister32, register2: GpRegister32)  {
    ...
    tracer.traceImplicitWrite(kasm.x64.GpRegister32.EAX, BitRange.BITS_0_63, false)
    tracer.traceWrite(kasm.x64.RflagsField.OF, false)
    tracer.traceWrite(kasm.x64.RflagsField.SF, false)
    tracer.traceWrite(kasm.x64.RflagsField.ZF, false)
    tracer.traceWrite(kasm.x64.RflagsField.PF, false)
...
object CmpxchgRm64R64Rax : R64m64R64Instruction() {
  ...
  override fun trace(tracer: InstructionTracer, register1: GpRegister64, register2: GpRegister64)  {
    ...
    tracer.traceWrite(register1, 0, BitRange.BITS_0_63, false)
    tracer.traceImplicitWrite(kasm.x64.GpRegister64.RAX, BitRange.BITS_0_63, false)
    tracer.traceWrite(kasm.x64.RflagsField.OF, false)
    tracer.traceWrite(kasm.x64.RflagsField.SF, false)
    tracer.traceWrite(kasm.x64.RflagsField.ZF, false)
    tracer.traceWrite(kasm.x64.RflagsField.PF, false)
...
object Cmpxchg8bM64EdxEaxEcxEbx : M64Instruction(), Cx8Instruction {
  ...
  private val features = enumSetOf(CX8)
  override fun isSupported(): Boolean  {
    return CpuId.features.containsAll(features)
  }
  override fun trace(tracer: InstructionTracer, addressExpression: AddressExpression64)  {
    ...
    tracer.traceImplicitRead(kasm.x64.GpRegister32.EAX, BitRange.BITS_0_31)
    tracer.traceImplicitRead(kasm.x64.GpRegister32.ECX, BitRange.BITS_0_31)
    tracer.traceImplicitRead(kasm.x64.GpRegister32.EBX, BitRange.BITS_0_31)
    tracer.traceWrite(addressExpression, 0)
    tracer.traceImplicitWrite(kasm.x64.GpRegister32.EDX, BitRange.BITS_0_63, false)
    tracer.traceImplicitWrite(kasm.x64.GpRegister32.EAX, BitRange.BITS_0_63, false)
    tracer.traceWrite(kasm.x64.RflagsField.ZF, false)
    tracer.endTracing()
  }
...
object Cmpxchg16bM128RdxRaxRcxRbx : M128Instruction(), Cx16Instruction {
  ...
  private val features = enumSetOf(CX16)
  override fun isSupported(): Boolean  {
    return CpuId.features.containsAll(features)
  }
  override fun trace(tracer: InstructionTracer, addressExpression: AddressExpression128)  {
    ...
    tracer.traceImplicitRead(kasm.x64.GpRegister64.RBX, BitRange.BITS_0_63)
    tracer.traceWrite(addressExpression, 0)
    tracer.traceImplicitWrite(kasm.x64.GpRegister64.RDX, BitRange.BITS_0_63, false)
    tracer.traceImplicitWrite(kasm.x64.GpRegister64.RAX, BitRange.BITS_0_63, false)
    tracer.traceWrite(kasm.x64.RflagsField.ZF, false)
    tracer.endTracing()
  }
