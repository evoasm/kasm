...
object CmpsdXmm0To63Xmmm64Imm8 : XmmXmmm64Imm8Instruction(), VectorInstruction, Sse2Instruction {
  ...
  override fun encode(buffer: ByteBuffer, parameters: InstructionParameters, options: EncodingOptions, tracer: InstructionTracer?)  {
    if(parameters.useSibd()) {
      encode(buffer, parameters.getXmmRegister(0, true, true), parameters.getAddressExpression64(1, true, false), parameters.getByteImmediate(2), options, tracer)
    }
    else {
  ...
  override fun trace(tracer: InstructionTracer, parameters: InstructionParameters)  {
    if(parameters.useSibd()) {
      trace(tracer, parameters.getXmmRegister(0, true, true), parameters.getAddressExpression64(1, true, false), parameters.getByteImmediate(2))
    }
    else {
...
object VcmpsdXmmXmmXmmm64Imm8 : XmmXmmXmmm64Imm8Instruction(), VectorInstruction, AvxInstruction {
...
object CmpssXmm0To31Xmmm32Imm8 : XmmXmmm32Imm8Instruction(), VectorInstruction, SseInstruction {
  override fun encode(buffer: ByteBuffer, register1: XmmRegister, register2: XmmRegister, immediate: Byte, options: EncodingOptions, tracer: InstructionTracer?)  {
    if(tracer != null) trace(tracer, register1, register2, immediate)
...
object VcmpssXmmXmmXmmm32Imm8 : XmmXmmXmmm32Imm8Instruction(), VectorInstruction, AvxInstruction {
  override fun encode(buffer: ByteBuffer, register1: XmmRegister, register2: XmmRegister, register3: XmmRegister, immediate: Byte, options: EncodingOptions, tracer: InstructionTracer?)  {
    if(tracer != null) trace(tracer, register1, register2, register3, immediate)
    Encoding.encodeLegacyPrefixes(buffer, options.legacyPrefixOrder, options.legacyPrefix1, options.legacyPrefix2, options.legacyPrefix3, options.encodedLegacyPrefix4)
...
object CmpxchgRm8R8Al : R8m8R8Instruction() {
  ...
  override fun trace(tracer: InstructionTracer, register1: GpRegister8, register2: GpRegister8)  {
    ...
    tracer.traceWrite(register1, false, BitRange.BITS_0_7, false)
    tracer.traceWrite(kasm.x64.GpRegister8.AL, true, BitRange.BITS_0_7, false)
    tracer.traceWrite(kasm.x64.RflagsField.OF, false)
    tracer.traceWrite(kasm.x64.RflagsField.SF, false)
    tracer.traceWrite(kasm.x64.RflagsField.ZF, false)
    tracer.traceWrite(kasm.x64.RflagsField.PF, false)
  ...
  override fun encode(buffer: ByteBuffer, parameters: InstructionParameters, options: EncodingOptions, tracer: InstructionTracer?)  {
    if(parameters.useSibd()) {
      encode(buffer, parameters.getAddressExpression8(0, true, true), parameters.getGpRegister8(1, true, false), options, tracer)
    }
    else {
  ...
  override fun trace(tracer: InstructionTracer, parameters: InstructionParameters)  {
    if(parameters.useSibd()) {
      trace(tracer, parameters.getAddressExpression8(0, true, true), parameters.getGpRegister8(1, true, false))
    }
    else {
...
object CmpxchgRm16R16Ax : R16m16R16Instruction() {
  ...
  override fun trace(tracer: InstructionTracer, register1: GpRegister16, register2: GpRegister16)  {
    ...
    tracer.traceWrite(kasm.x64.GpRegister16.AX, true, BitRange.BITS_0_15, false)
    tracer.traceWrite(kasm.x64.RflagsField.OF, false)
    tracer.traceWrite(kasm.x64.RflagsField.SF, false)
    tracer.traceWrite(kasm.x64.RflagsField.ZF, false)
    tracer.traceWrite(kasm.x64.RflagsField.PF, false)
  ...
  override fun encode(buffer: ByteBuffer, parameters: InstructionParameters, options: EncodingOptions, tracer: InstructionTracer?)  {
    if(parameters.useSibd()) {
      encode(buffer, parameters.getAddressExpression16(0, true, true), parameters.getGpRegister16(1, true, false), options, tracer)
    }
    else {
  ...
  override fun trace(tracer: InstructionTracer, parameters: InstructionParameters)  {
    if(parameters.useSibd()) {
      trace(tracer, parameters.getAddressExpression16(0, true, true), parameters.getGpRegister16(1, true, false))
    }
    else {
...
object CmpxchgRm32R32Eax : R32m32R32Instruction() {
  ...
  override fun trace(tracer: InstructionTracer, register1: GpRegister32, register2: GpRegister32)  {
    ...
    tracer.traceWrite(kasm.x64.GpRegister32.EAX, true, BitRange.BITS_0_63, false)
    tracer.traceWrite(kasm.x64.RflagsField.OF, false)
    tracer.traceWrite(kasm.x64.RflagsField.SF, false)
    tracer.traceWrite(kasm.x64.RflagsField.ZF, false)
    tracer.traceWrite(kasm.x64.RflagsField.PF, false)
...
object CmpxchgRm64R64Rax : R64m64R64Instruction() {
  ...
  override fun trace(tracer: InstructionTracer, register1: GpRegister64, register2: GpRegister64)  {
    ...
    tracer.traceWrite(register1, false, BitRange.BITS_0_63, false)
    tracer.traceWrite(kasm.x64.GpRegister64.RAX, true, BitRange.BITS_0_63, false)
    tracer.traceWrite(kasm.x64.RflagsField.OF, false)
    tracer.traceWrite(kasm.x64.RflagsField.SF, false)
    tracer.traceWrite(kasm.x64.RflagsField.ZF, false)
    tracer.traceWrite(kasm.x64.RflagsField.PF, false)
...
object Cmpxchg8bM64EdxEaxEcxEbx : M64Instruction(), Cx8Instruction {
  ...
  override fun trace(tracer: InstructionTracer, addressExpression: AddressExpression64)  {
    ...
    tracer.traceRead(kasm.x64.GpRegister32.EAX, true, BitRange.BITS_0_31)
    tracer.traceRead(kasm.x64.GpRegister32.ECX, true, BitRange.BITS_0_31)
    tracer.traceRead(kasm.x64.GpRegister32.EBX, true, BitRange.BITS_0_31)
    tracer.traceWrite(addressExpression)
    tracer.traceWrite(kasm.x64.GpRegister32.EDX, true, BitRange.BITS_0_63, false)
    tracer.traceWrite(kasm.x64.GpRegister32.EAX, true, BitRange.BITS_0_63, false)
    tracer.traceWrite(kasm.x64.RflagsField.ZF, false)
    tracer.endTracing()
  }
...
object Cmpxchg16bM128RdxRaxRcxRbx : M128Instruction(), Cx16Instruction {
  ...
  override fun trace(tracer: InstructionTracer, addressExpression: AddressExpression128)  {
    ...
    tracer.traceRead(kasm.x64.GpRegister64.RAX, true, BitRange.BITS_0_63)
    tracer.traceRead(kasm.x64.GpRegister64.RCX, true, BitRange.BITS_0_63)
    tracer.traceRead(kasm.x64.GpRegister64.RBX, true, BitRange.BITS_0_63)
    tracer.traceWrite(addressExpression)
    tracer.traceWrite(kasm.x64.GpRegister64.RDX, true, BitRange.BITS_0_63, false)
    tracer.traceWrite(kasm.x64.GpRegister64.RAX, true, BitRange.BITS_0_63, false)
    tracer.traceWrite(kasm.x64.RflagsField.ZF, false)
    tracer.endTracing()
  }
  override fun encode(buffer: ByteBuffer, parameters: InstructionParameters, options: EncodingOptions, tracer: InstructionTracer?)  {
    encode(buffer, parameters.getAddressExpression128(0, true, true), options, tracer)
  }
  override fun trace(tracer: InstructionTracer, parameters: InstructionParameters)  {
    trace(tracer, parameters.getAddressExpression128(0, true, true))
  }
}
object ComisdXmmXmmm64 : XmmXmmm64Instruction(), VectorInstruction, Sse2Instruction {
