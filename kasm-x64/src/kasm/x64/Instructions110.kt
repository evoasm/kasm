...
object XorRm16Imm16 : R16m16Imm16Instruction() {
...
object XorRm32Imm32 : R32m32Imm32Instruction() {
...
object XorRm64Imm32 : R64m64Imm32Instruction() {
...
object XorRm16Imm8 : R16m16Imm8Instruction() {
...
object XorRm32Imm8 : R32m32Imm8Instruction() {
...
object XorRm64Imm8 : R64m64Imm8Instruction() {
...
object XorRm8R8 : R8m8R8Instruction() {
...
object XorRm16R16 : R16m16R16Instruction() {
...
object XorRm32R32 : R32m32R32Instruction() {
...
object XorRm64R64 : R64m64R64Instruction() {
...
object XorR8Rm8 : R8R8m8Instruction() {
  override fun encode(buffer: ByteBuffer, register1: GpRegister8, register2: GpRegister8, options: EncodingOptions, tracer: InstructionTracer?)  {
    if(tracer != null) trace(tracer, register1, register2)
    Encoding.encodeLegacyPrefixes(buffer, options.legacyPrefixOrder, options.legacyPrefix1, options.legacyPrefix2, options.legacyPrefix3, options.encodedLegacyPrefix4)
