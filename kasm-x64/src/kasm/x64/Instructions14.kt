...
object SetaRm8 : R8m8Instruction() {
  ...
  override fun encode(buffer: Buffer, address: Address8, options: EncodingOptions, tracer: InstructionTracer?)  {
    ...
    RexPrefix.Rm8.encode(buffer, options, address)
    Encoding.encodeOpcode(buffer, 0x0F, 0x97)
    ModRmSib.encode(buffer, options, address)
  }
...
object ShldRm16R16Imm8 : R16mR16Imm8Instruction() {
  ...
  override fun encode(buffer: Buffer, address: Address16, register: GpRegister16, immediate: Byte, options: EncodingOptions, tracer: InstructionTracer?)  {
  ...
  override fun trace(tracer: InstructionTracer, address: Address16, register: GpRegister16, immediate: Byte)  {
    tracer.beginTracing()
    tracer.traceRead(address)
    tracer.traceRead(register.topLevelRegister, false, BitRange._0_15)
    tracer.traceRead(immediate.toLong(), false, BitSize._8)
...
object ShldRm32R32Imm8 : R32mR32Imm8Instruction() {
  ...
  override fun encode(buffer: Buffer, address: Address32, register: GpRegister32, immediate: Byte, options: EncodingOptions, tracer: InstructionTracer?)  {
    if(tracer != null) trace(tracer, address, register, immediate)
    Encoding.encodeLegacyPrefixes(buffer, options.legacyPrefixOrder, options.legacyPrefix1, options.legacyPrefix2, options.legacyPrefix3, options.encodedLegacyPrefix4)
    RexPrefix.RegRm.encode(buffer, options, register, address)
    Encoding.encodeOpcode(buffer, 0x0F, 0xA4)
  ...
  override fun trace(tracer: InstructionTracer, address: Address32, register: GpRegister32, immediate: Byte)  {
    tracer.beginTracing()
    tracer.traceRead(address)
    tracer.traceRead(register.topLevelRegister, false, BitRange._0_31)
    tracer.traceRead(immediate.toLong(), false, BitSize._8)
...
object ShldRm64R64Imm8 : R64mR64Imm8Instruction() {
  ...
  override fun encode(buffer: Buffer, address: Address64, register: GpRegister64, immediate: Byte, options: EncodingOptions, tracer: InstructionTracer?)  {
    if(tracer != null) trace(tracer, address, register, immediate)
    Encoding.encodeLegacyPrefixes(buffer, options.legacyPrefixOrder, options.legacyPrefix1, options.legacyPrefix2, options.legacyPrefix3, options.encodedLegacyPrefix4)
    RexPrefix.RegRm.encodeMandatory(buffer, options, 1, register, address)
    Encoding.encodeOpcode(buffer, 0x0F, 0xA4)
  ...
  override fun trace(tracer: InstructionTracer, address: Address64, register: GpRegister64, immediate: Byte)  {
    tracer.beginTracing()
    tracer.traceRead(address)
    tracer.traceRead(register, false, BitRange._0_63)
    tracer.traceRead(immediate.toLong(), false, BitSize._8)
